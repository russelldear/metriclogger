...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *MetricLogger*):
...
Execute unit tests
```
    cd "MetricLogger/test/MetricLogger.Tests"
    dotnet test
```

Deploy application
```
    cd "MetricLogger/src/MetricLogger"
